    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdHostel = table.Column<int>(type: "integer", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Hostels", x => x.IdHostel);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_Hostels_IdHostel",
                        column: x => x.IdHostel,
                        principalTable: "Hostels",
                        principalColumn: "IdHostel",
                        onDelete: ReferentialAction.Cascade);
                });
