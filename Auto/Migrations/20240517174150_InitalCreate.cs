    ...
    public partial class InitalCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Questions_ImageData_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdTestQuestion = table.Column<string>(type: "text", nullable: false),
                    IdTest = table.Column<int>(type: "integer", nullable: false),
                    IdQuestion = table.Column<int>(type: "integer", nullable: false),
                    IdSelectedAnswer = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestQuestions", x => x.IdTestQuestion);
                    table.ForeignKey(
                        name: "FK_TestQuestions_AnswerOptions_IdSelectedAnswer",
                        column: x => x.IdSelectedAnswer,
                        principalTable: "AnswerOptions",
                        principalColumn: "AnswerId");
                    table.ForeignKey(
                        name: "FK_TestQuestions_Questions_IdQuestion",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestQuestions_IdQuestion",
                table: "TestQuestions",
                column: "IdQuestion");
